...
<div class="row">
    ...
    <table class="table mt-3">
        ...
        <tbody id="products-list">
            ...
            <tr id="product-{{$rowId}}">
                <td>
                    <select name="products[{{$rowId}}][product_id]" class="form-control input-product-product_id"
                ...
                <td>
                    <input type="number" name="products[{{$rowId}}][quantity]" value="{{ $rowProduct['quantity']?? 1 }}"
                        row-id="product-{{$rowId}}" class="form-control input-product-quantity">
                ...
                <td>
                    <input type="number" name="products[{{$rowId}}][price]" readonly
                        class="form-control input-product-price" row-id="product-{{$rowId}}"
                ...
                <td>
                    <input type="number" name="products[{{$rowId}}][total]" readonly
                        class="form-control input-product-total" row-id="product-{{$rowId}}"
            ...
            <tr id="product-1">
                ...
                <td>
                    <input type="number" name="products[1][quantity]" value="1" row-id="product-1"
                        class="form-control input-product-quantity">
                </td>
                <td>
                    <input type="number" name="products[1][price]" readonly class="form-control input-product-price"
                        row-id="product-1" value="{{ $products->first()->price }}">
                </td>
                <td>
                    <input type="number" name="products[1][total]" readonly class="form-control input-product-total"
                        row-id="product-1" value="{{ $products->first()->price }}">
                </td>
                <td>
